...
class MatrixInverse {
    ...
    // Invert the specified matrix. Assumes invertibility. Time Complexity: O(r2c)
    ...
    public static void main(String[] args) {
        MatrixInverse test = new MatrixInverse();
        double[][] d = new double[][]{{1,2,3}, {1,0,-1}, {0,1,1}};
        test.inverse(d);
    }
}
